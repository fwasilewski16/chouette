import méthodeFeuerstein from "../assets/images/pedagogie/méthodeFeuerstein.png";
import montessori from "../assets/images/pedagogie/montessori.png";
import bienÊtre from "../assets/images/pedagogie/bienÊtre.png";
import méthodeRaviv from "../assets/images/pedagogie/méthodeRaviv.png";

function PedagogieSingle(props) {
  return (
    <div className="mt-10 flex flex-col gap-3 px-4 sm:w-1/2 lg:w-1/3">
      <img src={props.img} className="aspect-square rounded-2xl object-cover" />
...
export default function PedagogiePage() {
  return (
    <section className="flex min-h-[calc(100dvh-60px-97px)] flex-col gap-10 bg-[#fffcf9] pb-10 font-montserrat tracking-wide antialiased xl:min-h-[calc(100dvh-80px-40px)]">
      <h1 className="bg-[#AF45FF] py-6 text-center text-4xl text-white lg:text-5xl">
        Notre pédagogie
      </h1>
      <div className="flex flex-col items-center">
        <div className="flex w-full max-w-[600px] flex-col items-center gap-10 px-4 text-center">
          <h2 className="text-4xl text-[#F9AB48] lg:text-5xl">
            Une pédagogie adaptée
          </h2>
          <p className="max-w-[415px] text-[14px] lg:max-w-[600px] lg:text-base">
          ...
          <p className="max-w-[415px] text-[14px] lg:max-w-[600px] lg:text-base">
            ...
            l'adolescent, en prêtant une attention particulière au dialogue avec
            les thérapeutes et l'école. Notre équipe vous propose des séances de
            travail fondées sur le partage, l'ouverture et le plaisir
            d'apprendre.
          </p>
        </div>
      </div>
