...
export default function MobileMenu(props) {
  return (
    <div
      className={`${!props.mobileMenuAnimation && "opacity-0"} absolute left-0 right-0 top-[52px] z-50 h-screen touch-none overflow-y-hidden backdrop-brightness-[.2] transition-all duration-700 ease-in-out`}
    >
      <div className="flex h-fit flex-col gap-3 bg-[#FFAF45] py-4">
