  ...
  return (
    <div className="flex max-w-[100vw] justify-center bg-[#FAF9F6] py-6 md:px-6 lg:py-20">
      <div className="mx-6 flex w-full max-w-[539px] justify-center lg:max-w-[1200px]">
        <div
          ref={textRef}
          className={`${crewTextVisible ? "" : "translate-x-6 opacity-0"} flex flex-col gap-4 transition delay-200 duration-1000 lg:w-1/2 lg:gap-16 lg:px-0 lg:transition-none`}
        >
